    ...
    <div class="container">
        ...
        <div class="card mb-3" style="max-width: 800px; background: #242526; padding: 10px; border: 1px solid #3e4042;">
            ...
            <div class="card-body">
                ...
                <p class="card-text"><small class="text-muted">@lang('post.view.mark'): {{count($post->marks)}}</small></p>
                    <form style="float: left" action="{{route('mark')}}" method="post">
                        @csrf
                ...
                <form style="float: right" action="{{route('mark')}}" method="post">
                    @csrf
